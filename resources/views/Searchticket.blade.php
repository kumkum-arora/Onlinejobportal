...
<body>
    ...
    <div class="text-gray-900 ">
        <div class="p-4 flex">
            ...
            Check Below Status of Your Application
            </h1>
        </div>
    </div>
    <!-- component -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-dark font-medium text-base py-5 px-2  bg-white border-b border-l border-[#E8E8E8]">
                                        @if($row->status == 1)
                                        <a  class=" border border-gray-400  py-2 px-4  text-black inline-block rounded bg-green-600  hover:text-white">Selected</a>
                                        @elseif($row->status == 2)
                                        <a  class=" border border-gray-400  py-2 px-4  text-black inline-block rounded bg-red-600  hover:text-white">Rejected</a>
                                        @else
                                        <a  class=" border border-gray-400  py-2 px-4  text-black inline-block rounded bg-primary  hover:text-white">Under Review</a>
                                        @endif
